...
$N\!\in\![50,512]$ sits \emph{pre-inversion} of the
chirality flip (empirical inversion at
$N_{\mathrm{inv}}\!\approx\!591$--$600$, where
$\theta_{\mathrm{chir}}\!=\!\pi/4$). All certification above
therefore applies to the \emph{vacuum branch}
($\theta_{\mathrm{chir}}\!<\!\pi/4$). Post-inversion
behaviour is open: the cross-branch invariance of
$\lambda_{\infty}$ is not predicted by the present data,
since the underlying $\xi/K/Q$ field-content does jump
across the flip (e.g.\ $\Lambda_{t}^{\rm vac}\!=\!33/40$
versus $\Lambda_{t}^{\rm mat}\!=\!81/100$). A future
ladder $N\!\in\![600,1024]$ either confirms universality
or forces a branch-resolved statement
$\lambda_{\infty}^{\rm vac}\!=\!3/8$ (certified) plus a
to-be-determined $\lambda_{\infty}^{\rm mat}$.
\end{proposition}
