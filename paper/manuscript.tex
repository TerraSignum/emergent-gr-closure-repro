...
embedding. The revised primary candidate is a quantitative
Cheeger argument controlled by degree concentration; the
empirical test is the degree-concentration audit
$\mathrm{Var}(\deg)/\mathrm{Mean}(\deg)^{2}\!\to\!0$ as
$N\!\to\!\infty$, to be reported in a subsequent Phase-2
Step-2 audit.
