...
\url{https://github.com/[anonymized]/emergent-gr-closure-repro} recomputes
...
$\mathcal P_{5}/\mathcal P_{5}N$ at $N\!\in\!\{64,100,200,300\}$,
the smallest non-zero eigenvalue $\lambda_{2}(N)$ of the
$\xi_{N}$-weighted normalised Laplacian on the first-seed
snapshot satisfies $\lambda_{2}(N)\!\in\![0.399,0.471]$, with
empirical lower bound
$\inf\lambda_{2}\!\approx\!0.40$ and median $0.42$. The
audit \path|src/verify_admissibility_counterexample_and_spectral_gap.py|
(output
\path|outputs/verify_admissibility_counterexample_and_spectral_gap.json|)
reports the verdict
\texttt{UNIFORM\_SPECTRAL\_GAP\_EMPIRICALLY\_CERTIFIED}.
\end{proposition}
...
equilibrium construction?} -- a question at the level of
discrete Bakry--\'Emery curvature
theory~\cite{Sturm2006,LottVillani2009} on $\xi$-weighted
graphs.
